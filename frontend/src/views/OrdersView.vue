...
import { ArrowLeft, Refresh, Search, View } from '@element-plus/icons-vue'
    ...
    <section class="workspace wide">
      ...
      <el-table v-loading="loading" :data="orders" class="data-table" border>
        ...
        <el-table-column label="操作" width="250" fixed="right">
          <template #default="{ row }">
            <el-button :icon="View" link type="primary" @click="router.push(`/orders/${row.id}`)">详情</el-button>
            <el-dropdown v-if="availableNextStatuses(row).length > 0" trigger="click">
